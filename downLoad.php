        ...
        $con=mysqli_connect("localhost","root","","fb");         
              ...
              $query=  mysqli_query($con,"select * from account where Email_id='$emailid'");
                while ($row = mysqli_fetch_array($query)) 
                {
                    ...
                    <p style="text-align: center"><a href="slideShow.php"> <img src="FolderIcon/Folder_icon.png" width="40" height="40"><?php echo $row["Fname"]?></a>                 
                     <a href="downloadinZip.php">DownLoad</a></p>
                   <?php
                ...
                ?>             
                  ...
                  <p style="text-align: center"><a href="UploadImage.php">Upload Image</a>
                      <br>
                      <br>
                  <p style="text-align: center"><a href="pictures.php"><< back</a>
       </body>
</html>